#http://www3.cs.stonybrook.edu/~algorith/implement/skeleton/implement.shtml
#http://jcb.rupress.org/content/204/3/443.full
#http://www.inf.u-szeged.hu/~palagyi/skel/skel.html
#http://www.dabi.temple.edu/~shape/partshape/structure/3.php
...
#     vy = reshape(vy([t;t]),2,[]);
    ...
    #         if sum(sum((abs(vx-vx(1,i))<delta)&(abs(vy-vy(1,i))<delta)))>1 and sum(sum((abs(vx-vx(2,i))<delta)&(abs(vy-vy(2,i))<delta)))>1:
...
if __name__ == "__main__":
    coords = np.array([[0, 6], [2, 6], [4, 6], [6, 6],  [0,1],[2, 1], [4,1], [6, 1], [0, 4], [6, 4]])
    model2mesh(coords)
